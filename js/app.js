document.addEventListener('DOMContentLoaded', function() {
    ...
    // Hardcoded data for demo (since fetch from file:// may not work in browser)
    ...
    function showMitraList() {
        ...
        mitraData.forEach(mitra => {
            ...
            card.innerHTML = `
                ...
                <button class="mitra-detail-btn" onclick="showMitraDetail('${JSON.stringify(mitra).replace(/'/g, \"&apos;\")}')">Detail</button>
            `;
    ...
    function showMitraDetail(mitraDataStr) {
        const mitra = JSON.parse(mitraDataStr.replace(/&apos;/g, "'"));
        ...
        // Add active class after append for smooth transition
